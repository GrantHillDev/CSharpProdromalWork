...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Console.ReadLine();
            Console.WriteLine();//while there are some differences between .Append() and .Add(), it appears that .Append() is more of a temporary addition to a given list, whereas, .Add() offers a more permanent addition to such a list.
        }
