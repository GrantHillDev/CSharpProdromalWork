namespace MethodsExercise
{
    public class Program
    {
        ...
        public static int Summation(params int[] collectionofNumbers) //we've created an array of intergers here, and named it.
        {
        ...
        {//However, I had a hunch that if I called this method somewhere within this program, that feature might chnage, to reflect the brightened yellow colored font that all of my other methods seem ot have -- I was right.
