...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            xmas.Presents =  new string[3]{"A large Ceramic Kiln","A brand new Desktop Computer","A brand new 72 inch flat screen Television" }; //once three different string values were entered within these brackets, the red squiggly line located within the same space dissappeared -- no more errors detected here.
