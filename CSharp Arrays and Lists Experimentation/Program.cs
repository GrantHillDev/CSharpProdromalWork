...
namespace CSharp_Arrays_and_Lists_Experimentation
{
    internal class Program
    {
        ...
        public static void implicitlyTypedArray2()
        {
        ...
        public static void implicitlyTypedArray3()
        {//be advised that VS Community will throw an error at you during code writing if you fail to assign a value to each of its slots when utilizing the slot value assignment strategy shown below.
            ...
            Console.WriteLine("");
            Console.WriteLine(impArray3.Length);//Arrays have this property, 'Length', that can be printed to the console, just like ion this instance.
        ...
        {
            var infArray3 = new string[] { "Centurion", "Arcanis", "Selene", "Magnus", "Isabelle", "Cataclysm", "Malignity", "Draevourn" };//try the previous method, but backwards order.
        ...
        public static void implicitlyTypedList1()//lists don't need to have their size declared before implementing instances of them, unlike arrays.
        {
        ...
        public static void implicitlyTypeList2()
        {
